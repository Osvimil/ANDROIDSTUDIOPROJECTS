package oswaldoadidas.hotmail.com.googlemapssecond;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng iztacalco = new LatLng(19.390263, -99.119453);
        mMap.addMarker(new MarkerOptions().position(new LatLng(0, 0)).title("Marcador"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(iztacalco));
