...
import com.appspot.oswaldopsendpoints.backend.proxyEndpointSaludo.ProxyEndpointSaludo;

import com.appspot.oswaldopsendpoints.backend.proxyEndpointSaludo.model.Nombres;

import com.appspot.oswaldopsendpoints.backend.proxyEndpointSaludo.model.Saludo;
...
public class FragmentSaludo extends Fragment {
    ...
    private static final String URL_REMOTA = "https://oswaldopsendpoints.appspot.com";
    ...
    private static final String EXCEPTION_FALTA_NOMBRE = "com.appspot.oswaldopsendpoints.backend.ExceptionFaltaNombre";
    ...
    public void clicEnSaludar() {
        ...
        if (proxy != null) {
            ...
            task = new AsyncTask<Nombres, Void, String>() {
                ...
                @Override protected String doInBackground(Nombres... modelo) { //Los tres puntos son un arreglo de Nombres
