...
package com.appspot.oswaldopsendpoints.backend;
...
import static com.appspot.oswaldopsendpoints.backend.Constantes.FORMATO_DEL_SALUDO;

import static com.appspot.oswaldopsendpoints.backend.Constantes
...
@Api(name = "proxyEndpointSaludo", version = "v1",namespace = @ApiNamespace(ownerDomain = "backend.oswaldopsendpoints.appspot.com",

        ownerName = "backend.oswaldopsendpoints.appspot.com", packagePath = ""))
